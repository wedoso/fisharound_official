(() => {
  ...
  const japanese = {
    ...
    "Because Fish Around does not collect personal data or provide accounts, advertising, real-money purchases, or social features, it does not knowingly collect information from children.": "Fish Aroundは個人データを収集せず、アカウント、広告、現金での購入、ソーシャル機能を提供しないため、子どもから情報を意図的に収集することはありません。",
    ...
    "How do I unlock themes and decorations?": "テーマや飾りを解放するには？",
    "Spend time by the pond to earn bubbles, then choose a locked item and confirm before spending them. Halloween Night can be unlocked only from September 1 through October 31; once unlocked, it remains in your collection.": "池で過ごして泡を集め、未解放の項目を選び、泡を使う前に確認してください。ハロウィーンの夜は9月1日から10月31日まで解放でき、一度解放するとコレクションに残ります。",
  ...
  const korean = {
    ...
    "Because Fish Around does not collect personal data or provide accounts, advertising, real-money purchases, or social features, it does not knowingly collect information from children.": "Fish Around는 개인 데이터를 수집하지 않고 계정, 광고, 현금 구매, 소셜 기능을 제공하지 않으므로 아동의 정보를 의도적으로 수집하지 않습니다.",
    ...
    "How do I unlock themes and decorations?": "테마와 장식은 어떻게 해제하나요?",
    "Spend time by the pond to earn bubbles, then choose a locked item and confirm before spending them. Halloween Night can be unlocked only from September 1 through October 31; once unlocked, it remains in your collection.": "연못에서 시간을 보내 방울을 모은 다음 잠긴 항목을 선택하고 사용 전에 확인하세요. 핼러윈 밤은 9월 1일부터 10월 31일까지만 해제할 수 있으며, 한 번 해제하면 컬렉션에 계속 남습니다.",
  ...
  Object.assign(japanese, {
    ...
    "tap · watch · unwind": "タップ · 眺める · ひと休み",
    "iPhone + iPad": "iPhone + iPad",
    "Portrait and landscape": "縦向き・横向き",
    "Works offline": "オフライン対応",
    "No account required": "アカウント不要",
    "No ads": "広告なし",
    "No tracking or real-money purchases": "追跡・現金での購入なし",
    "5 languages": "5言語に対応",
    "Made for a quiet pause": "静かなひと休みのために",
    "New in version 2.0": "バージョン2.0の新要素",
    "Four ponds, four moods.": "4つの池、4つの気分。",
    "Each pond has its own portrait and landscape painting, ambient color, music, decorations, and hand-painted interface.": "各池には、縦向きと横向きそれぞれの絵、環境の色、音楽、飾り、手描きの画面があります。",
    "Spring Pond": "春の池",
    "Soft leaves and clear morning water.": "やわらかな若葉と澄んだ朝の水。",
    "Summer Night": "夏の夜",
    "Moonlit lilies in a deep blue pond.": "深い青の池に浮かぶ、月明かりの睡蓮。",
    "Autumn Pond": "秋の池",
    "Warm reeds, stone, and fallen leaves.": "あたたかな葦と石、舞い落ちた葉。",
    "Halloween Night": "ハロウィーンの夜",
    "A seasonal pond, available September 1–October 31.": "9月1日から10月31日まで楽しめる季節限定の池。",
    "Limited time": "期間限定",
    "A pond that remembers": "思い出を残す池",
    "Small moments become keepsakes.": "小さな時間が、思い出の品になる。",
    "Spend time with Tangerine, Red Bean, Blue Nap, and Inky. Familiarity grows at its own pace, and each fish may return with a photo and a few words of its own.": "タンジェリン、レッドビーン、ブルーナップ、インキーと一緒に過ごしましょう。親しさはゆっくり育ち、それぞれの魚が写真と自分らしい言葉を持ち帰ることがあります。",
    "Tap the water, visit a fish, or simply watch.": "水をタップしたり、魚を訪ねたり、ただ眺めたり。",
    "Ambient moments": "池の小さな出来事",
    "Discover small theme-specific surprises.": "テーマごとの小さな驚きを見つけましょう。",
    ...
    "Available to unlock during the season. Once unlocked, it stays in your pond collection.": "期間中に解放できます。一度解放すると、池のコレクションに残ります。",
  ...
  Object.assign(korean, {
    ...
    "tap · watch · unwind": "톡 · 바라보기 · 쉬어가기",
    "iPhone + iPad": "iPhone + iPad",
    "Portrait and landscape": "세로 및 가로 화면",
    "Works offline": "오프라인 지원",
    "No account required": "계정 불필요",
    "No ads": "광고 없음",
    "No tracking or real-money purchases": "추적 및 현금 구매 없음",
    "5 languages": "5개 언어 지원",
    "Made for a quiet pause": "조용한 쉼을 위해",
    "New in version 2.0": "버전 2.0의 새로운 내용",
    "Four ponds, four moods.": "네 개의 연못, 네 가지 분위기.",
    "Each pond has its own portrait and landscape painting, ambient color, music, decorations, and hand-painted interface.": "각 연못에는 세로와 가로용 그림, 고유한 빛과 색, 음악, 장식, 손그림 인터페이스가 있습니다.",
    "Spring Pond": "봄 연못",
    "Soft leaves and clear morning water.": "부드러운 새잎과 맑은 아침 물빛.",
    "Summer Night": "여름밤",
    "Moonlit lilies in a deep blue pond.": "짙은 푸른 연못 위 달빛 수련.",
    "Autumn Pond": "가을 연못",
    "Warm reeds, stone, and fallen leaves.": "따뜻한 갈대와 돌, 떨어진 낙엽.",
    "Halloween Night": "핼러윈 밤",
    "A seasonal pond, available September 1–October 31.": "9월 1일부터 10월 31일까지 만날 수 있는 기간 한정 연못.",
    "Limited time": "기간 한정",
    "A pond that remembers": "기억하는 연못",
    "Small moments become keepsakes.": "작은 순간이 소중한 기억이 됩니다.",
    "Spend time with Tangerine, Red Bean, Blue Nap, and Inky. Familiarity grows at its own pace, and each fish may return with a photo and a few words of its own.": "탠저린, 레드빈, 블루냅, 잉키와 시간을 보내세요. 친밀감은 천천히 자라고, 물고기마다 사진과 자기다운 한마디를 가져오기도 합니다.",
    "Tap the water, visit a fish, or simply watch.": "물을 톡 건드리거나, 물고기를 만나거나, 그저 바라보세요.",
    "Ambient moments": "연못의 작은 순간",
    "Discover small theme-specific surprises.": "테마마다 다른 작은 놀라움을 발견하세요.",
    ...
    "Available to unlock during the season. Once unlocked, it stays in your pond collection.": "시즌 동안 해제할 수 있으며, 한 번 해제하면 연못 컬렉션에 계속 남습니다.",
  ...
  function toTraditionalChinese(text) {
    const replacements = [
      ["首页", "首頁"], ["隐私", "隱私"], ["支持", "支援"], ["下载", "下載"], ["立即下载", "立即下載"], ["一方小池塘", "一方小池塘"],
      ["横屏与竖屏", "橫向與直向"], ["万圣节", "萬聖節"], ["限时", "限時"], ["真钱", "現金"],
      ["留给", "留給"], ["时刻", "時刻"], ["不着急", "不著急"], ["每条", "每條"], ["会", "會"],
      ["独立", "獨立"], ["音乐", "音樂"], ["开放", "開放"], ["一直", "一直"], ["收藏", "收藏"],
      ["获得", "獲得"], ["默认", "預設"], ["计时", "計時"],
